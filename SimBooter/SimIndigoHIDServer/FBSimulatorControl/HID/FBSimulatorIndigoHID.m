...
#import "FBControlCore/Async/FBFuture.h"
#import "Indigo.h"
...
+ (IndigoMessage *)touchMessageWithPayload:(IndigoTouch *)payload messageSizeOut:(size_t *)messageSizeOut
{
  ...
  message->payload.type = 0x0000000b;
  ...
  second->event.touch.index = 0x00000001;
  second->event.touch.identity = 0x00000002;
...
- (IndigoMessage *)touchMessageWithPoint:(CGPoint)point direction:(FBSimulatorHIDDirection)direction messageSizeOut:(size_t *)messageSizeOut
{
  ...
  IndigoTouch payload;
  payload.eventMask = 0x00400002;
  payload.index = 0x1;
  payload.identity = 0x3;
